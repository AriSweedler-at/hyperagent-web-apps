 ...
 * the room, the relay-forced game, resume and the handoff, written once over tools/games.ts
 * SHELL_GAMES. Both shell games' suites claim them; the tags decide which describes each job plays.
 */
