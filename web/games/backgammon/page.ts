  ...
  table: `      <!-- TABLE (design §2.1). The 24 points are direct children of #board in absolute order;
      ...
      <div id="tableScreen" class="hidden">
        ...
        <div class="controls" id="controls">
          <!-- Whose turn (the owner, 2026-09-25): a small arrow in the mover's checker colours that
               points at their side of the table (data-seat, data-side from render.ts paintTurn);
               their tray wears the same colours (theme.css .off.to-move). -->
          <svg
            ...
            focusable="false"
          >
            <path d="M12 21 5 13h4V3h6v10h4z" />
          </svg>
          <div class="me-strip">
