// GENERATED by tools/legacy/debundle-fidice.ts from legacy/fidice/index.html lines 1038-1153
// (bundle section "// src/bots/strategies/profiler.ts"): the body is verbatim, indentation included; the imports
...
export {
  LIE_WEIGHT, PRIOR, WEIGHT, CORNER, LINE, CREDIT, TIMID, HOLD_BACK,
  CONTENT_GAP, CONTENT_WHIM, clamp, blend, receivedBy, meanOr, profileOf, myVerdicts,
  inPenance, creditOf, holdChance, callLineOf, topRungAbove, receiveBid, aimAt, turnKey2,
  planTurn2, shake, canShake, profiler,
};
